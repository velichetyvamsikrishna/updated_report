...
?>
<table >
	<caption><strong>On Mobile</strong></caption>
	<thead>
	...
	<?php
		...
		for($i=0;$i<count($mobile);$i++){
			echo "<tr><td><strong>$mobile[$i]</strong></td>";
...
<table>
	<caption><strong>On Desktop</strong></caption>
	<thead>
	<th>Test Pass Name</th>
	<th>Total</th><th>Active</th><th>Fixed</th><th>Won't Fix</th><th>External</th><th>Duplicate</th><th>Not Repro</th><th>By Design</th>
	</thead>
	...
	<?php
		...
		for($i=0;$i<count($desktop);$i++){
			echo "<tr><td ><strong>$desktop[$i]</strong></td>";
