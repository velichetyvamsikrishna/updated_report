...
echo "<option>Settings</option><option value='High'>High Contrast</option><option>Keyboard</option><option value='Color'>Color Contrast</option><option>Browser</option><option>Speech</option><option>JAWS</option><option>NVDA</option>";
